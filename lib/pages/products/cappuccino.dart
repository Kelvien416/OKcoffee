...
class _cappuccinoState extends State<cappuccino> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(221, 62, 62, 62),
      appBar: AppBar(
        title: const Text(
          'OKapp',
                      ...
                      children: [
                        Expanded(
                          ...
                          children: [
                            ...
                            const Text(
                              'our espresso based cappuccino, with balanced flavour between espresso and hot milk.',
